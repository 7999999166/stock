<script>
    ...
    var yy = [] ;
    function getData(){axios.get('https://spreadsheets.google.com/feeds/list/13K9S87Q2KThfv3emCM5FA2V_JrR57Z_tQRnfKWmQe1A/od6/public/values?alt=json')
...
<div class="bb">
	...
	{#each yy as item}
     <div class="aa w3-card-4">
       <img src="https://res.cloudinary.com/kanik/image/upload/v1626630278/Bawana/ss-dustbin-500x500_u6elsv.jpg" alt="Alps" class="zz">
