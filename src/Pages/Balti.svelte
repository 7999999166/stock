<script>
    ...
    var yy = [] ;
    function getData(){axios.get('https://spreadsheets.google.com/feeds/list/1QjJVeQq-pcL4VYF2D7Q8g7BPLqISqc8oHNTphjsPUmk/od6/public/values?alt=json')
...
<div class="bb">
	...
	{#each yy as item}
     <div class="aa w3-card-4">
       <img src="https://res.cloudinary.com/kanik/image/upload/v1626676837/Bawana/stainless-steel-buckets-500x500_o9fhxh.jpg" alt="Alps" class="zz">
